...
\begin{document}
	...
	\begin{resumo}
		As Transformações Lineares são aplicações entre espaços vetoriais que preservam a estrutura vetorial, mantendo propriedades como soma e multiplicação por escalar. Essas transformações são essenciais na matemática aplicada, física e engenharia, sendo fundamentais para resolver sistemas de equações lineares e problemas práticos em ciência e engenharia. A linearidade, que preserva a adição e a multiplicação por escalar, é uma propriedade chave das transformações lineares, permitindo a utilização da álgebra matricial para resolver problemas do mundo real.
		
		Além disso, o estudo do núcleo, imagem, dimensão e isomorfismo das transformações lineares é crucial para compreender a estrutura dos espaços vetoriais e como as transformações afetam esses espaços. A representação das transformações lineares em termos de matrizes é uma técnica importante para sua aplicação em áreas como geometria, física, engenharia e economia. Por meio dessas transformações, é possível modelar e resolver uma variedade de problemas em diferentes contextos, demonstrando a versatilidade e poder das transformações lineares na resolução de desafios práticos e teóricos.
		
		Portanto, este estudo, busca compreender e aprofundar o ramo de estudo das transformações lineares, suas aplicações e demonstrar alguns feitos práticos na sociedade.
	...
	\begin{resumo}[Abstract]
		\begin{otherlanguage*}{english}
			Linear transformations are mappings between vector spaces that preserve the vector structure, maintaining properties such as addition and scalar multiplication. These transformations are essential in applied mathematics, physics, and engineering, playing a fundamental role in solving systems of linear equations and practical problems in science and engineering. Linearity, which preserves addition and scalar multiplication, is a key property of linear transformations, enabling the use of matrix algebra to solve real-world problems.
			
			Furthermore, the study of the kernel, image, dimension, and isomorphism of linear transformations is crucial for understanding the structure of vector spaces and how transformations affect these spaces. The representation of linear transformations in terms of matrices is an important technique for their application in areas such as geometry, physics, engineering, and economics. Through these transformations, it is possible to model and solve a variety of problems in different contexts, demonstrating the versatility and power of linear transformations in addressing practical and theoretical challenges.
			
			Therefore, this study aims to comprehend and delve into the branch of linear transformations, their applications, and demonstrate some practical achievements in society.
