...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.00]{figures/a_robo1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.70]{figures/a_robo2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.80]{figures/a_robo3.png}
	\caption{Rotação e translação \cite{sirlandro2017}.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.80]{figures/a_robo4.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.80]{figures/a_robo5.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=1.00]{figures/a_robo6.png}
