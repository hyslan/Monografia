...
\usepackage{csquotes}
\usepackage[
	style=abnt,           % Estilo alfabético da ABNT
    backend=biber,        % Motor moderno de compilação
    backref=true,         % Ativa o "Citado na página X"
    justify,              % Justifica o texto das referências
    extrayear,            % Adiciona a, b, c em anos repetidos do mesmo autor
    giveninits=false,     % Imprime nomes completos (mude para true se quiser apenas iniciais)
    uniquename=init
]{biblatex}
...
% Mapeia o seu arquivo .bib para o biblatex
\addbibresource{references.bib}

% Configuração para traduzir o "backref" para o português
